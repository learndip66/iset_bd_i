CREATE IF NOT EXISTS DATABASE vivero;
...
alter table pedido add foreign key(codigo_cliente)
...
alter table cliente add foreign key(codigo_empleado_rep_ventas) references empleado(codigo_empleado);
...
CREATE INDEX idx_detalle_pedido_pedido ON detalle_pedido(codigo_pedido);
CREATE INDEX idx_detalle_pedido_producto ON detalle_pedido(codigo_producto);
CREATE INDEX idx_pago_cliente ON pago(codigo_cliente);
CREATE INDEX idx_empleado_oficina ON empleado(codigo_oficina);
CREATE INDEX idx_empleado_jefe ON empleado(codigo_jefe);
CREATE INDEX idx_cliente_empleado_rep ON cliente(codigo_empleado_rep_ventas);
...
-- ============================================
-- INICIO DE TRANSACCIÓN PARA INSERCIONES
-- ============================================
START TRANSACTION;
...
-- select count(*) from oficina; -- Comentado para optimización
...
-- select count(*) from producto; -- Comentado para optimización
...
-- select * from empleado; -- Comentado para optimización
...
-- select count(*) from pago; -- Comentado para optimización
